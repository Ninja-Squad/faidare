...
//        site.setAdditionalInfo(additionalInfo);
    ...
    public static StudyV1VO createStudy() {
        StudyV1VO study = new StudyV1VO();
...
//        study.setAdditionalInfo(additionalInfo);
    ...
    public static GermplasmV1VO createGermplasm() {
        ...
        germplasm.setSynonyms(List.of("BLE DU ROUSSILLON", "FRA051:1699", "ROUSSILLON"));
...
//        germplasm.setBreeder(breeder);
    ...
    public static GermplasmV1VO createGermplasmMinimal() {
        GermplasmV1VO germplasm = new GermplasmV1VO();
