...
public class GermplasmExportService {
    ...
    public void export(OutputStream out, Stream<GermplasmV1VO> germplasms, List<GermplasmExportableField> fields) {
        try {
    ...
    private static class GermplasmExportableFieldDescriptor {
        ...
        private final Function<GermplasmV1VO, String> exporter;

        public GermplasmExportableFieldDescriptor(String header,
                                                  Function<GermplasmV1VO, String> exporter) {
            this.header = header;
        ...
        public String export(GermplasmV1VO germplasm) {
