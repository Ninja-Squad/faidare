...
public class GermplasmController {
    ...
    public ModelAndView get(@PathVariable("germplasmId") String germplasmId) {
        GermplasmV1VO germplasm = germplasmRepository.getByGermplasmDbId(germplasmId);
    ...
    public ModelAndView getByPui(@RequestParam("pui") String pui) {
        GermplasmV1VO germplasm = germplasmRepository.getByGermplasmPUI(pui);
    ...
    public ResponseEntity<StreamingResponseBody> export(@Validated @RequestBody GermplasmExportCommand command) {
        ...
        StreamingResponseBody body = out -> {
            try (Stream<GermplasmV1VO> stream = germplasmRepository.findByGermplasmDbIdIn(command.getIds())) {
    ...
    private void sortPopulations(GermplasmV1VO germplasm) {
    ...
    private void sortCollections(GermplasmV1VO germplasm) {
    ...
    private void sortPanels(GermplasmV1VO germplasm) {
    ...
    private void sortDonors(GermplasmV1VO germplasm) {
