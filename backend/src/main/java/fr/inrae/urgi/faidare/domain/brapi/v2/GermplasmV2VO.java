...
public class GermplasmV2VO {
    ...
    public List<GermplasmInstituteVO> getBreeder() {
        return breeder;
    }

    public void setBreeder(List<GermplasmInstituteVO> breeder) {
    ...
    public void setGermplasmPreprocessing(String germplasmPreprocessing) { this.germplasmPreprocessing = germplasmPreprocessing; }
